...
(yas-define-snippets 'org-mode
			...
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/yas.org" nil nil)
			...
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/smk_int" nil nil)
		       ("smk.rulegraph" "#+ATTR_ORG: :width 800px\n[[file:resources/$1_smk.png]]\n" "smk.rulegraph" nil nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/smk.rulegraph" nil nil)
			...
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/smk.rule.r" nil nil)
			...
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/smk.rule.py" nil nil)
			...
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/smk.rule.bash" nil nil)
		       ("smk.rule" "smk.rule.${1:$$(yas-choose-value '(\"bash\" \"r\"))}\n\n# -*- mode: snippet -*-\n# key: smk.rule\n# expand-env: ((yas-indent-line 'none))\n# --\n#+begin_src snakemake\nrule ${1:$$(downcase(replace-regexp-in-string \" \" \"_\" yas-text))}:\n    input:\n    log: f\"{log_dir}/$1.log\",\n    output:\n    params: script = $1\n    shell:\n        \"\"\"\n        \"\"\"\n$0\n#+end_src\n" "smk.rule" nil nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/smk.rule" nil nil)
		       ("smk.rscript" "    params:\n        script = f\"{$2_script_dir}/${1:$$(replace-regexp-in-string \" \" \"_\" yas-text)}.R\"\n    shell:\n        \"\"\"\n        Rscript {params.script} \\\n        {input} \\\n        {output} > {log} 2>&1\n        \"\"\"\n#+end_src\n- [[file:./scripts/$1.R][Rscript]]\n  #+begin_src R :tangle ./scripts/$1.R\nr.script$0\n#+end_src\n" "smk.rscript" nil nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/smk.rscript" nil nil)
			...
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/smk.org.rule" nil nil)
		       ("smk.bashscript" "    params:\n        script = script_dir + \"/${1:$$(replace-regexp-in-string \" \" \"_\" yas-text)}.sh\"\n    shell:\n        \"\"\"\n        {params.script} \\\n        {input} \\\n        {output} &> {log}\n        \"\"\"\n#+end_src\n#+begin_src bash :tangle ./scripts/$1.sh\n$0\n#+end_src\n" "smk.bashscript" nil nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/smk.bashscript" nil nil)
			...
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/smk" nil nil)
		       ("prop" ":properties:\n$0\n:end:\n" "prop" nil nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/prop" nil nil)
		       ("open_choose" "#+begin_src bash\n\n#+end_src\n" "open_choose" nil nil
			((yas-indent-line 'fixed))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/open_choose" nil nil)
			...
			((yas-indent-line 'fixed))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/launch.docker.interactive" nil nil)
		       ("head.notangle" ":PROPERTIES:\n:header-args: :tangle no\n:END:\n" "head.notangle" nil nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/head.notangle" nil nil)
		       ("google" "[[https://www.google.com/search?q=${1:$(replace-regexp-in-string \" \" \"+\" yas-text)}][google:$1]]$0\n" "google" nil nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/google" nil nil)
			...
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/demo.org.header" nil nil)
		       ("code.smk" "#+begin_src snakemake\n$0\n#+end_src\n" "code.smk" nil nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/code.smk" nil nil)
		       ("code.sh" "#+begin_src bash\n$0\n#+end_src`(if (eobp) \"\" \"\\n\")`" "code.sh" 'auto nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/code.sh" nil nil)
		       ("code.r" "#+begin_src R\n$0\n#+end_src\n" "code.r" nil nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/code.r" nil nil)
		       ("code.py" "#+begin_src python\n$0\n#+end_src\n" "code.py" 'auto nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/code.py" nil nil)
		       ("code.prop" ":PROPERTIES:\n:header-args:${1:`(yas-choose-value '(\"R\" \"bash\" \" \"))`}: :tangle $2\n:END:\n$0\n" "code.prop" nil nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/code.prop" nil nil)
		       ("code.lisp" "#+begin_src emacs-lisp\n$0\n#+end_src\n" "code.lisp" 'auto nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/code.lisp" nil nil)
		       ("code.latex" "#+begin_src latex\n$0\n#+end_src\n" "code.latex" 'auto nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/code.latex" nil nil)
		       ("code.js" "#+begin_src javascript\n$0\n#+end_src\n" "code.js" 'auto nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/code.js" nil nil)
			...
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/anki.cloze" nil nil)
		       ("80" "#########1#########2#########3#########4#########5#########6#########7#########8\n" "80" nil nil
			((yas-indent-line 'none))
			"/home/jeszyman/.emacs.d/public_yasnippets/org-mode/80" nil nil)))
